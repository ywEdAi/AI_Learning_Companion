...
8. No pre or post wording. Directly return the name of the domain in triple brackets, without html.  Then return the bulleted summary in HTML collapsibles for each bullet and sub bullet (using the <details> and <summary> tags in HTML to create sections that users can click to expand or collapse) ..
'''
...
5. No pre or post wording. ONLY return the bulleted summary in HTML collapsibles for each bullet and sub bullet (using the <details> and <summary> tags in HTML to create sections that users can click to expand or collapse).
...
def Analyze(PDF):
    ...
    components.html(result,
                    scrolling = True,
                    height = 500)
    return domain_name, html, result
