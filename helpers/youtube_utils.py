...
from youtube_transcript_api import (
    YouTubeTranscriptApi, YouTubeRequestFailed, VideoUnavailable,  TooManyRequests,
...
def get_transcript_text(video_id):
    ...
    except (YouTubeRequestFailed, VideoUnavailable, TooManyRequests, NoTranscriptAvailable, NotTranslatable,
